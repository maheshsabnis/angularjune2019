...
export class ProductLogic {
    ...
    constructor() {
        ...
        this.products.push(new ProductInfo(11, 'Prd0001', 'Laptop', 123000, 'Electronics', 'IBM', 'ROG'));
        this.products.push(new ProductInfo(22, 'Prd0002', 'Desktop', 23000, 'Electronics', 'IBM', 'Developer'));
    }
